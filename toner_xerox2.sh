...
limpo="/tmp/limpo.html"
bruto="/tmp/bruto.html"
...
sed -r "s/^([1-2]?[0-9]{1,2}?\.[1-2]?[0-9]{1,2}?\.[1-2]?[0-9]{1,2}?\.[1-2]?[0-9]{1,2}?) .+ ([0-9]{1,3}?%).+ ([0-9]{1,3}?%).+ ([0-9]{1,3}?%).+ ([0-9]{1,3}?%).*$/<TR><TD>\1<\/TD><TD>\2<\/TD><TD>\3<\/TD><TD>\4<\/TD><TD>\5<\/TD><\/TR>/g" >> $limpo
